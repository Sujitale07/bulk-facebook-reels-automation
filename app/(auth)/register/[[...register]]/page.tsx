    ...
    <div className="min-h-screen bg-black text-[#e0e0e0] font-mono flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-2xl tracking-[0.2em] font-bold text-white uppercase mb-2">New Protocol</h1>
          <p className="text-[#666] text-[10px] uppercase tracking-widest">Initialize Node Membership</p>
        </div>
